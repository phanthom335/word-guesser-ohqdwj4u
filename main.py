    """
    Word Guesser Ohqdwj4u
    =====================
    Fun terminal game that challenges players to explore puzzles in ASCII art.
    ...
    APP_NAME    = "Word Guesser Ohqdwj4u"
    APP_VERSION = "1.0.0"
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Fun terminal game that challenges players to explore puzzles in ASCII art.")
